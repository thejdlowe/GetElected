var calcBonus = function() {	//This...this is such a simple thing, but I didn't think of it. Thanks, Siveran!
	var cap = 3;	//cap = 1 = 100%; the most is a 100% boost right now. The higher the cap, the more it's possible for players to boost. Later, I might raise this.
	return (totalRestart / (250 + totalRestart)) * cap;
}
